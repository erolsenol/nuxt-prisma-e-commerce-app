...
CREATE TABLE `Comment` (
    ...
    FULLTEXT INDEX `Comment_username_title_content_idx`(`username`, `title`, `content`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ContactUs` (
    ...
    FULLTEXT INDEX `ContactUs_name_surname_email_phone_title_content_idx`(`name`, `surname`, `email`, `phone`, `title`, `content`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
